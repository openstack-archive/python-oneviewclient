...
class OneViewClientTestCase(unittest.TestCase):
    ...
    @mock.patch.object(client.Client, '_wait_for_task_to_complete',
                       autospec=True)
    @mock.patch.object(client.Client, 'prepare_and_do_request', autospec=True)
    ...
    def test_set_power_on_server_hardware(self, mock_get_node_power,
        ...
        mock_prepare_do_request.assert_called_once_with(
            oneview_client,
            uri='/any/powerState',
    ...
    def test_set_power_on_nonexistent_server_hardware(
    ...
    def test_set_power_on_server_hardware_power_status_error(
        self, mock_get_node_power, mock_prepare_do_request, mock__authenticate
    ):
        power = states.ERROR
    ...
    def test_validate_node_server_hardware_inconsistent_memorymb_value(
        ...
        node_uuid = '1a2b3c4d5e'
        node_memorymb = 2
        node_cpus = 1

        exc_expected_msg = (
            "Node 1a2b3c4d5e memory_mb is inconsistent with OneView's server"
    ...
    def test_validate_node_server_hardware_inconsistent_cpus_value(
        ...
        exc_expected_msg = (
            "Node 1a2b3c4d5e cpus is inconsistent with OneView's server"
    ...
    def test_validate_node_server_hardware_type_empty_sht_uri(
        ...
        exc_expected_msg = (
            "Node 1a2b3c4d5e properties/capabilities server_hardware_type_uri "
            "is empty. Node validation failed."
        )
    ...
    def test_validate_node_server_hardware_type_inconsistent_sht_uri(
        ...
        exc_expected_msg = (
            "Node 1a2b3c4d5e server_hardware_type_uri is inconsistent with"
    ...
    def test_validate_node_enclosure_group_inconsistent(
        ...
        exc_expected_msg = (
            "Node 1a2b3c4d5e enclosure_group_uri is inconsistent with"
    ...
    def test_check_node_port_mac_is_compatible_with_server_profile_fail(
        ...
        exc_expected_msg = (
            "Port of node 1a2b3c4d5e is not compatible with applied server"
    ...
    def test_validate_node_server_profile_template_empty_spt_uri(
        self, mock__authenticate
    ):
        driver_info = {
            "server_hardware_uri": "/any_uri",
        ...
        exc_expected_msg = (
            "Node 1a2b3c4d5e driver_info/server_profile_template_uri is"
