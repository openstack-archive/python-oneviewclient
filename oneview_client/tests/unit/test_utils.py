...
class UtilsTestCase(unittest.TestCase):
    ...
    def test__get_empty_bootable_ports(self):
        ...
        ports = [port]
        self.assertEqual(
            [], utils.get_bootable_ports(ports, True)
        )
    ...
    def test__get_empty_not_bootable_ports(self):
        ...
        ports = [port]
        self.assertEqual(
            [], utils.get_bootable_ports(ports, False)
        )
    ...
    def test__get_no_pxe_enabled_ports(self):
        ...
        ports = [port]
        self.assertEqual(
            [], utils.get_pxe_enabled_ports(ports)
        )
    ...
    def test__get_pxe_enabled_ports(self):
        ...
        ports = [port]
        self.assertEqual(
            ports, utils.get_pxe_enabled_ports(ports)
        )
    ...
    def test__get_multiple_pxe_enabled_ports(self):
        ...
        ports = [port1, port2, port3]
        self.assertEqual(
            [port1, port3], utils.get_pxe_enabled_ports(ports)
        )
