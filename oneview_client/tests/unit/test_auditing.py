...
class OneViewClientAuditTestCase(unittest.TestCase):
    ...
    def setUp(self, mock__authenticate):
        ...
        self.mock_write_audit_output_file = mock.Mock()
        auditing.read_audit_map_file = self.mock_read_audit_map_file
        auditing.write_audit_output_file = self.mock_write_audit_output_file
    ...
    def test_oneview_auditing_mapped_method(self):
        ...
        self.assertTrue(self.mock_write_audit_output_file.called)
        self.assertEqual(2, self.mock_write_audit_output_file.call_count)
    ...
    def test_oneview_auditing_not_mapped_method(self):
        ...
        self.assertFalse(self.mock_write_audit_output_file.called)

    @mock.patch('uuid.uuid4')
    def test_oneview_auditing_write_in_json_twice(self, mock_uuid):

        mock_uuid.return_value = '1111-2222-3333-4444-55555'
        ...
        class Client(object):
            ...
            @auditing.audit
            def auditable_method(self, *args, **kwargs):
                return 42

        Client().auditable_method(self, 'foo', 'bar', buzz=123)

        self.mock_write_audit_output_file.assert_any_call(
            method_name='auditable_method:1111-2222-3333-4444-55555',
            audit_output_file='oneview_audit_output_file.json',
            args="('foo', 'bar')",
            kwargs="{'buzz': 123}"
        )
