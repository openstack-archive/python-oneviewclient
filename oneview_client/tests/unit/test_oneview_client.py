...
class OneViewClientTestCase(unittest.TestCase):
    ...
    def test_clone_template_and_apply_assignment(
        ...
        fake_server_profile = models.ServerProfile()
        fake_server_profile.uri = \
            '/rest/server-profiles/AAAAAAAA-BBBB-CCCC-DDDD-EEEEEEEE'
        mock_get_server_profile_by_uuid.return_value = fake_server_profile
