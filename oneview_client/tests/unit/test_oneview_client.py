...
class OneViewClientTestCase(unittest.TestCase):
    ...
    @mock.patch.object(client.Client, '_prepare_and_do_request', autospec=True)
    def test_create_tagged_network(
        self, mock__prepare_do_request, mock__authenticate
    ):
        oneview_client = client.Client(
            self.manager_url,
    ...
    @mock.patch.object(requests, 'post')
    def test_create_invalid_network(
        self, mock_post, mock__authenticate
    ):
        oneview_client = client.Client(
            self.manager_url,
            self.username,
    ...
    @mock.patch.object(requests, 'post')
    def test_create_invalid_tagged_network_without_vlan_tag(
        self, mock_post, mock__authenticate
    ):
        oneview_client = client.Client(
            self.manager_url,
