...
class TestEthernetNetworkManager(unittest.TestCase):
    ...
    def setUp(self, mock__authenticate):
        self.oneview_client = client.Client(
            manager_url='https://something', username='user', password='pass')
        self.server_profile_manager = managers.EthernetNetworkManager(
            self.oneview_client
        )
    ...
    def _test__is_a_valid_ethernet_network_type_expecting_value_with_type(
        ...
        self.assertEqual(
            expected_value,
            self.server_profile_manager._is_a_valid_ethernet_network_type(
    ...
    def test_create_with_invalid_ethernet_network_type(self):
        ...
        self.assertRaises(
            ValueError, self.server_profile_manager.create, **kwargs
        )
    ...
    def test_create_invalid_ethernet_network(self, mock_post):
        ...
        self.assertRaises(
            ...
            self.server_profile_manager.create, **kwargs
        )
    ...
    def test_create_tagged_ethernet_network(
        ...
        mock__prepare_and_do_request.assert_called_once_with(
            self.server_profile_manager.oneview_client,
    ...
    def test_update_name(
        ...
        self.server_profile_manager.update_name(
        ...
        mock__prepare_and_do_request.assert_called_once_with(
            self.server_profile_manager.oneview_client, uri=network_uri,
    ...
    def test_delete(
        ...
        self.server_profile_manager.delete(network_uuid)
...
class TestUplinkSetManager(unittest.TestCase):
    ...
    @mock.patch.object(managers.UplinkSet, 'get', autospec=True)
