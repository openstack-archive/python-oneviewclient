...
class Client(object):
    ...
    def set_node_power_state(
        ...
        if current_state is states.ONEVIEW_UNKNOWN:
            message = (
    ...
    def apply_server_profile(self, server_profile_name, node_info):
        ...
        return self.get_server_profile_from_hardware(node_info)
    ...
    def delete_server_profile_from_server_hardware(self, node_info):
        ...
        if server_profile_uri:
            ...
            try:
                ...
                raise exceptions.OneviewServerProfileDeletionError(
                    e.message
                )
    ...
    def validate_spt_boot_connections(self, node_info):
        server_profile_template = self.get_server_profile_template(node_info)
