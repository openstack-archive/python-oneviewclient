...
#             self.log_insecure_connection()
    ...
    def verify_oneview_version(self):
        if self.is_oneview_version_compatible() is True:
    ...
    def power_on(self, driver_info):
        if self.get_node_power_state(driver_info) == states.POWER_ON:
            ret = states.POWER_ON
        else:
    ...
    def power_off(self, driver_info):
        if self.get_node_power_state(driver_info) == states.POWER_OFF:
